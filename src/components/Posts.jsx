...
function Posts() {
    ...
    useEffect(() => {
        ...
        setDataUsersPosts(data != "" ? Object.values(data.map((i) => i.posts)) : "nahi aya")
        set(allUsersPosts != "" ? Object.values(allUsersPosts) : "nahi aya")
        
    }, [data]);
    
    allUsersPosts.push(dataUsersPosts)
